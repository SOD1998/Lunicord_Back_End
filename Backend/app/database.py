...
class DatabaseConnection:
    ...
    @classmethod
    def execute_query(cls, query, params=None, database_name=None):
    ...
    @classmethod
    def fetch_all(cls, query, params=None, database_name=None):
        cursor = cls.get_connection().cursor()
        cursor.execute(query, params)
        return cursor.fetchall()
    
    @classmethod
    def fetch_one(cls, query, params=None, database_name=None):
        cursor = cls.get_connection().cursor()
        cursor.execute(query, params)
